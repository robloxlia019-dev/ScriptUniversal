...
Win.Size = UDim2.new(0, 350, 0, 600)
...
do
    ...
    TweenService:Create(Win,TweenInfo.new(0.5,Enum.EasingStyle.Back,Enum.EasingDirection.Out),
        {Position=UDim2.new(0.5,-175,0.5,-300)}):Play()
    -- Stroke animado
    task.spawn(function()
        local h = 0.6
        while Win.Parent do
...
local selBox = Frame(Color3.fromRGB(12,20,40), Win,
    UDim2.new(0,10,0,378), UDim2.new(1,-20,0,36), 8)
do
...
local statBox = Frame(Color3.fromRGB(12,18,30), Win,
    UDim2.new(0,10,0,422), UDim2.new(1,-20,0,52), 10)
do
...
local btnImport = Btn("📥  IMPORTAR", Color3.fromRGB(40,100,220), Win,
    UDim2.new(0,10,0,484), UDim2.new(0.6,-14,0,54))
do
...
local btnRefresh = Btn("🔄 Atualizar", Color3.fromRGB(30,40,80), Win,
    UDim2.new(0.6,4,0,484), UDim2.new(0.4,-14,0,54))
