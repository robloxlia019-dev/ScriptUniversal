...
do
    ...
    local function makeLangBtn(text, lang, yPos, colorFrom, colorTo)
        ...
        btn.MouseButton1Click:Connect(function()
            LANG = lang
            tween(LangScreen, {Position = UDim2.new(0.5, -160, 1.5, 0), BackgroundTransparency = 1}, 0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In)
