...
local function createGUI()
    ...
    local function createSection(name)
        ...
        section.Text = " ── " .. name .. " ──"
        section.TextColor3 = Color3.fromRGB(180, 140, 255)
    ...
    local function createToggle(text, callback, isActive)
        ...
        btn.BackgroundColor3 = isActive and Color3.fromRGB(70, 180, 70) or Color3.fromRGB(40, 40, 60)
        ...
        btn.MouseButton1Click:Connect(function()
            active = not active
            callback(active)
            btn.BackgroundColor3 = active and Color3.fromRGB(70, 180, 70) or Color3.fromRGB(40, 40, 60)
    ...
    local function createInputButton(placeholder, btnText, color, callback)
        ...
        input.Size = UDim2.new(0.68, -3, 1, 0)
        ...
        btn.Position = UDim2.new(0.7, 3, 0, 0)
